...
@REGISTERED_LR_SCHEDULER.register_module(LrSechedulerName.LinearIncreaseLR)
...
@REGISTERED_LR_SCHEDULER.register_module(LrSechedulerName.MultiStageLR)
...
@REGISTERED_LR_SCHEDULER.register_module(LrSechedulerName.PolyLR)
...
@REGISTERED_LR_SCHEDULER.register_module(LrSechedulerName.CosineLR)
