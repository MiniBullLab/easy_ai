...
from easyai.model.model_block.base_block.seg.unet_blcok import DoubleConv2d, DownBlock
from easyai.model.model_block.base_block.seg.unet_blcok import AttentionUpBlock
