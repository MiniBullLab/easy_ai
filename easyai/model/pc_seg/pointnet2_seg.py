...
from easyai.model_block.base_block.pc_cls.pointnet2_block import PointNet2BlockName
from easyai.model_block.base_block.pc_cls.pointnet2_block import PointNetSetAbstractionMRG
from easyai.model_block.base_block.pc_cls.pointnet2_block import PointNetFeaturePropagation
from easyai.model.utility.base_classify_model import *
from easyai.model.utility.model_registry import REGISTERED_PC_SEG_MODEL


@REGISTERED_PC_SEG_MODEL.register_module(ModelName.PointNet2Seg)
class PointNet2Seg(BaseClassifyModel):

    def __init__(self, data_channel=3, class_number=13):
        super().__init__(data_channel, class_number)
        self.set_name(ModelName.PointNet2Seg)
