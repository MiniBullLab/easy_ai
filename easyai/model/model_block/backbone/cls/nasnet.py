...
from easyai.model.model_block.base_block.cls.nasnet_block import NasNetBlockName
from easyai.model.model_block.base_block.cls.nasnet_block import NormalCell, ReductionCell
