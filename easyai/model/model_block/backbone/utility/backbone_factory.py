...
import os.path
from easyai.model.model_block.backbone.utility.my_backbone import MyBackbone
...
from easyai.model.model_block.backbone.utility.backbone_registry import REGISTERED_GAN_G_BACKBONE
