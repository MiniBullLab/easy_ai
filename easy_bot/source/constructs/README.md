...
npm run build
cdk bootstrap  # run this line at the first time
cdk deploy --parameters Domain=mystaticsite.com --parameters SSLCertificateId=ABCDEFGHIJKLMNOPQ1234 --parameters LoginDomain=xxx.authing.cn
```
