...
class PFNLayer(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        self.linear = nn.Linear(in_channels, self.out_channels, bias=False)
        self.norm = NormalizeLayer(bn_name, self.out_channels)
        self.mode = mode
...
class PillarFeatureNet(BaseBlock):
    """Pillar Feature Net.
    ...
    def __init__(self,
                 ...
                 mode='max'):
        super().__init__(PCEncoderName.PillarFeatureBlock)
