...
@REGISTERED_DATASET_COLLATE.register_module(DatasetCollateName.MosaicDataSetCollate)
class MosaicDataSetCollate(BaseDatasetCollate):
    ...
    def __call__(self, batch_list):
        ...
        for i, all_data in enumerate(batch_list):
            ...
            all_data['label'][:, 0] = i  # add target image index for build_targets()
