...
from easyai.model.model_block.base_block.seg.fast_scnn_block import FastSCNNBlockName
from easyai.model.model_block.base_block.seg.fast_scnn_block import GlobalFeatureExtractor, FeatureFusionBlock
