...
from easyai.model.model_block.base_block.cls.xception_block import EntryFlow, ExitFLow
from easyai.model.model_block.base_block.cls.xception_block import MiddleFLowBlock
