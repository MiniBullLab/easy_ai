...
class OneClassDataloader(TorchDataLoader):
...
def get_one_class_train_dataloader(train_path, data_config, num_workers=8):
    ...
    dataloader = OneClassDataloader(train_path, resize_type, normalize_type, mean, std,
...
def get_one_class_val_dataloader(val_path, data_config, num_workers=8):
    resize_type = data_config.resize_type
    normalize_type = data_config.normalize_type
    mean = data_config.data_mean
    std = data_config.data_std
