...
from easyai.data_loader.keypoint2d.landmark_dataset_process import LandmarkDataSetProcess
from easyai.data_loader.keypoint2d.landmark_augment import LandmarkDataAugment
...
class LandmarkDataset(TorchDataLoader):
    ...
    def __init__(self, data_path, class_name,
                 ...
                 points_count=68, is_augment=False, transform_func=None):
