...
@REGISTERED_DATASET_COLLATE.register_module(DatasetCollateName.Pose2dDataSetCollate)
class Pose2dDataSetCollate(BaseDatasetCollate):
    ...
    def __call__(self, batch_list):
        ...
        list_labels = torch.stack(list_labels)
